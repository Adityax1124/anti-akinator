...
const Matchmaking = () => {
  ...
  // Auto-select top 10 cards by power
  ...
  // ===== CREATE ROOM - Stay on page with invite button =====
    ...
    searchIntervalRef.current = setInterval(async () => {
      ...
      if (attempts >= 4) {
        ...
        try {
          ...
          if (response.data.success) {
            setMode('create');
            // ✅ Quick match - auto navigate to battle
            setTimeout(() => {
  ...
  return (
    <div className="matchmaking-container premium-bg">
      <div className="matchmaking-header">
        <div className="header-glow"></div>
        <h1 className="matchmaking-title">
          <span className="title-icon">⚔️</span>
          Card Battle Arena
          <span className="title-sub">Premium PvP</span>
        </h1>
      ...
      {error && (
        <div className="matchmaking-error premium-alert error">
          <span className="alert-icon">❌</span>
          {error}
        </div>
      )}
      {success && (
        <div className="matchmaking-success premium-alert success">
          <span className="alert-icon">✅</span>
          {success}
        </div>
      )}
      ...
      {mode === 'searching' ? (
        ...
        <div className="matchmaking-options premium-grid">
          {/* Quick Match */}
          <div className="match-option premium-card quick-match">
          ...
          {/* Create Room - WITH INVITE BUTTON */}
          <div className="match-option premium-card create-match">
            <div className="option-glow"></div>
            <div className="option-icon">👑</div>
            ...
            {createdMatchCode ? (
              <div className="room-created-section">
                <div className="room-actions">
                  <button 
                    className="btn-invite-friend premium-btn invite-btn"
                  ...
                  <button 
                    className="btn-start-battle premium-btn battle-btn"
                    onClick={goToBattle}
                  >
                    ⚔️ Enter Lobby
                  </button>
